...
GUISettingsButton::GUISettingsButton(si32 width, si32 height)
:GUIButton(width, height)
{
    
}

GUISettingsButton::GUISettingsButton(GUIContainer* parent, si32 width, si32 height)
...
void GUISettingsButton::renderRays(float rayWidth)
{
    int rayCount = 0;
...
sbool GUISettingsButton::OnEvent( Event& event)
{
...
void GUISettingsButton::rayTraceForSinkGlow()
{
    if( !m_bIsClipped )
    {
        return;
...
void GUISettingsButton::pushRayDataToRayVertexBuffer(float rayWidth, Ray& ray, int rayCount)
{

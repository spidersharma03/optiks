...
GUIBackButton::GUIBackButton(si32 width, si32 height)
:GUIButton(width, height)
{
    
}

GUIBackButton::GUIBackButton(GUIContainer* parent, si32 width, si32 height)
...
void GUIBackButton::renderRays(float rayWidth)
{
    int rayCount = 0;
...
sbool GUIBackButton::OnEvent( Event& event)
{
...
void GUIBackButton::rayTraceForSinkGlow()
{
    if( !m_bIsClipped )
    {
        return;
...
void GUIBackButton::pushRayDataToRayVertexBuffer(float rayWidth, Ray& ray, int rayCount)
{

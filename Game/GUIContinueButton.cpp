...
GUIContinueButton::GUIContinueButton(si32 width, si32 height)
:GUIButton(width, height)
{
    
}

GUIContinueButton::GUIContinueButton(GUIContainer* parent, si32 width, si32 height)
...
void GUIContinueButton::renderRays(float rayWidth)
{
    int rayCount = 0;
...
sbool GUIContinueButton::OnEvent( Event& event)
{
...
void GUIContinueButton::rayTraceForSinkGlow()
{
    if( !m_bIsClipped )
    {
        return;
    ...
    Vector2f p0( h*0.5f, 0.0f);
    Vector2f p1( -h*0.5f, h*0.5f);
    Vector2f p2( -h*0.5f, -h*0.5f);

//    p0.x += m_GlobalTransform.col3.x + m_Size.x*0.5f;
//    p0.y += m_GlobalTransform.col3.y + m_Size.y*0.5f;
//
//    p1.x += m_GlobalTransform.col3.x + m_Size.x*0.5f;
//    p1.y += m_GlobalTransform.col3.y + m_Size.y*0.5f;
//
//    p2.x += m_GlobalTransform.col3.x + m_Size.x*0.5f;
//    p2.y += m_GlobalTransform.col3.y + m_Size.y*0.5f;
...
void GUIContinueButton::pushRayDataToRayVertexBuffer(float rayWidth, Ray& ray, int rayCount)
{
